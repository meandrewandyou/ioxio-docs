...
`}
  ...
  <ul>
    ...
    <li>
      <b>DataProducts</b>- contains the OpenAPI spec version of each definition in <b>*.json</b>
      files in an identical folder structure. These files are automatically generated by the pre-commit
      hooks before you commit.
    </li>
  </ul>
  <p>
