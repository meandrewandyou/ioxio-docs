...
<TableOfContents>
  ...
  <p>You can find the available data definitions via the menu.</p>
...
`}
  ...
  <p>
    ...
    the URL and change the data to match the expected payload of your own data source):
  </p>
  <Code lang={python}>
    {`
  curl --include \\
...
`}
  ...
  <p>
    ...
    header, once the datasource is switched to private the header should be added to request.
  </p>
  <p>
