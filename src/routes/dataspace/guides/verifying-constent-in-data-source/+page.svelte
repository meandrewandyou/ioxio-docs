...
<TableOfContents>
  ...
  <p>
    The <a
      href="https://well-known-docs.sandbox.ioxio-dataspace.com/consent-token.html"
      target="_blank"
    >
      consent token</a
    >
    is a
    <a href="https://datatracker.ietf.org/doc/html/rfc7519" target="_blank">JSON Web Token (JWT)</a>
  ...
  <p>
    ...
    <a href="https://jwtio" target="_blank"> jwt.io</a>, as well as a fairly good list of different
    <a href="https://jwt.io/libraries" target="_blank">JWT libraries</a> for different programming languages.
  </p>
  <p>
...
`}
  ...
  <img src="/decoded_consent_token_2024-01-08.png" alt="decoded consent token" />
  <p>
