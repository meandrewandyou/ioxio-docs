...
<TableOfContents>
  ...
  <SectionTitle title="Example signed code" />
  <p>
    The line feeds are added to make it easier to see what the code is like, but are not a part of
    the code. Having extra linefeeds breaks the code.
  </p>
